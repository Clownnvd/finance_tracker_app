...
mixin _$Budget {
 ...
 int get id; String get userId; int get categoryId; double get amount; int get month;
...
@override
String toString() {
  return 'Budget(id: $id, userId: $userId, categoryId: $categoryId, amount: $amount, month: $month)';
}
...
@useResult
$Res call({
 int id, String userId, int categoryId, double amount, int month
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String userId,  int categoryId,  double amount,  int month)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Budget() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String userId,  int categoryId,  double amount,  int month)  $default,) {final _that = this;
switch (_that) {
case _Budget():
return $default(_that.id,_that.userId,_that.categoryId,_that.amount,_that.month);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String userId,  int categoryId,  double amount,  int month)?  $default,) {final _that = this;
switch (_that) {
case _Budget() when $default != null:
return $default(_that.id,_that.userId,_that.categoryId,_that.amount,_that.month);case _:
  return null;
...
class _Budget implements Budget {
  const _Budget({required this.id, required this.userId, required this.categoryId, required this.amount, required this.month});
